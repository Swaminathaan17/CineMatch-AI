...
def test_plot_overview_adds_semantic_signal():
    import pandas as pd
    df = pd.DataFrame([
        {"id": 1, "title": "Space Mission", "overview": "astronaut stranded on mars survival mission", "genres": "Science Fiction", "cast": "Actor A", "director": "Director A", "keywords": "space"},
        {"id": 2, "title": "Mars Rescue", "overview": "astronaut must survive alone on mars and find a way home", "genres": "Science Fiction", "cast": "Actor B", "director": "Director B", "keywords": "rescue"},
        {"id": 3, "title": "Wedding Day", "overview": "friends prepare for a wedding celebration", "genres": "Romance", "cast": "Actor C", "director": "Director C", "keywords": "wedding"},
    ])
    engine = ContentSimilarityEngine(df)
    matches = engine.get_similar(1, top_n=2)
